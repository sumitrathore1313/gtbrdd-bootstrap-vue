...
} from 'gtbrdd-bootstrap-vue/<%= options.dist %>/components';
<% } %>
...
} from 'gtbrdd-bootstrap-vue/<%= options.dist %>/directives';
<% } %>

<% if (options.config) { %>
import BVConfigPlugin from 'gtbrdd-bootstrap-vue/<%= options.dist %>/bv-config';
...
<% } else { %>
import BootstrapVue from 'gtbrdd-bootstrap-vue/<%= options.dist %>';
